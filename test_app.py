...
if page == "수업 소개":
    ...
    <body>
        ...
        <script>
            function initMap() {{
                const schoolPosition = {{ lat: 37.571298, lng: 126.991867 }};  // 서울경운학교 좌표 (정확한 위치)
                const mapOptions = {{
    ...
    # Google 지도 바로가기 링크
    google_maps_url = "https://www.google.com/maps/search/convenience+stores+near+%EB%8C%80%ED%95%9C%EB%AF%BC%EA%B5%AD+%EC%84%9C%EC%9A%B8%ED%8A%B9%EB%B3%84%EC%8B%9C+%EC%A2%85%EB%A1%9C%EA%B5%AC+%EC%82%BC%EC%9D%BC%EB%8C%80%EB%A1%9C+454/"
    st.markdown(
        f"""
