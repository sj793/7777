...
if page == "수업 소개":
    ...
    <head>
        ...
        <title>편의점 지도</title>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD7lt0KSanRvYmQaJ3CQ0gZGVS-y1urcNI"></script>
        <style>
            #map {{
                width: 100%;
                height: 500px;
            ...
            function initMap() {{
                ...
                convenienceStores.forEach((store) => {{
                    ...
                    const infoWindow = new google.maps.InfoWindow({{
                        content: `<div style="text-align:center;padding:10px;">${{store.name}}</div>`
                    }});
